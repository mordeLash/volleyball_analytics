...
from src.rally_predictor.extract_features import extract_features_v6 as extract_features
...
def main():
    ...
    rf_model_path = "./models/rally_prediction/rally_predictor_rf_netball_v1.pkl"
...
# Define your game names
    ...
    label_csvs = [
       ...
       r"C:\Users\morde\Desktop\projects\volleyball_cv_project\output\training_data\game_netball_1_rally_labels_per_frame.csv",
    ]
    ...
    d3_csv2 = r"C:\Users\morde\Desktop\projects\volleyball_cv_project\src\_notebooks\ball_coords_net_3d.csv"
    d3_features2 = "ball3d_net_f.csv"
